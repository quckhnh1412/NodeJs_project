...
```
cd existing_repo
git remote add origin https://gitlab.duthu.net/S52000771/nodejs_n41.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.duthu.net/S52000771/nodejs_n41/-/settings/integrations)
